...
// Type: TrackingSync.Event.Rescue
...
{
  public class Rescue : Evento
  {
    public Rescue(Tracking tracking) => this.tracking = tracking;

    public override void ObtenerEstadoTecnico()
    {
      string eventoUltimaNovedad = this.tracking.EventoUltimaNovedad;
      if (!(eventoUltimaNovedad == "IntroduccionDeMotivo"))
      {
        ...
        this.estadoTecnico = "rescueIntroduccionDeMotivo";
    }
  }
}
